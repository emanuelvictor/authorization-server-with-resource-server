...
-- Name: group; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public.group OWNER TO "erp";

--
-- TOC entry 198 (class 1259 OID 41093)
-- Name: group_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: group_permission; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public.group_permission OWNER TO "erp";


--
-- TOC entry 200 (class 1259 OID 41100)
-- Name: group_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: application; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public.application OWNER TO "erp";

--
-- TOC entry 202 (class 1259 OID 41107)
-- Name: application_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: permission; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public.permission OWNER TO "erp";

--
-- TOC entry 205 (class 1259 OID 41125)
-- Name: permission_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: revisions; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public.revisions OWNER TO "erp";

--
-- TOC entry 208 (class 1259 OID 41137)
-- Name: revisions_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: user; Type: TABLE; Schema: public; Owner: erp
--
...
ALTER TABLE public."user" OWNER TO "erp";

--
-- TOC entry 210 (class 1259 OID 41144)
-- Name: user_id_seq; Type: SEQUENCE; Schema: public; Owner: erp
--
...
-- Name: group_permission group_permission_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: group group_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: application application_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: permission permission_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: revisions revisions_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: group uk_2rpgfvxump55l2ycp3bjhgi8j; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: group_permission uk_group_permission; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: permission uk_atogak43scua5hr2pnnaevywq; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: user uk_sb8bbouer5wak8vyiiy4pf2bx; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: user user_pkey; Type: CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: group_permission fk_group_permission_group; Type: FK CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: group_permission fk_group_permission_permission; Type: FK CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: application fk_application_group; Type: FK CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: permission fk_permission_permission; Type: FK CONSTRAINT; Schema: public; Owner: erp
--
...
-- Name: user fk_user_group; Type: FK CONSTRAINT; Schema: public; Owner: erp
--
